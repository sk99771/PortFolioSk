...
//                             <div
//                                 key={id}
//                                 className='md:w-[300px] md:h-[300px] border-[2px] rounded-lg shadow-lg p-4 cursor-pointer hover:scale-105 duration-300 flex flex-col items-center text-center'
//                             >
//                                 <img
//                                     src={logo}
//                                     alt={name}
//                                     className='w-[120px] h-[120px] p-1 rounded-full border-2 border-gray-300 mb-4'
//                                 />
